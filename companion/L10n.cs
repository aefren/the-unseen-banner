...
namespace TheUnseenBanner.Companion
{
    ...
    internal static class L10n
    {
        ...
        private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
        {
            ...
            // World-map company/campaign list (phase 4.4, F2 then Up/Down).
            ["world.status.screen"] = "Company status. Use Up and Down to review. Press F2 to close.",
            ...
            ["help.combat.status"] = "T reads the active man's health, action points, fatigue and morale.",
            ...
            ["help.world.status"] = "F2 opens the company status: day, crowns, food, ambition and contract.",
