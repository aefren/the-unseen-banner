...
namespace TheUnseenBanner.Companion
{
    ...
    internal static class L10n
    {
        ...
        private static readonly Dictionary<string, string> English = new(StringComparer.Ordinal)
        {
            ...
            ["tile.morale"] = "Morale: {0}",
            ["tile.corpse"] = "Corpse: {0}",
            ["tile.ground.one"] = "Ground item: {0}",
            ["tile.ground.many"] = "Ground items: {0}",
            ["combat.ground.item"] = "{0}. Move to backpack: {1} Action Points.",
            ["combat.ground.position"] = "Item {0} of {1}.",
            ["combat.ground.opened"] = "Ground items. {0} Use Up and Down to choose; Enter takes the focused item; P or Escape closes.",
            ["combat.ground.none"] = "No pickable ground items at the active man's position. Move him onto an item tile first.",
            ["combat.ground.skill_armed"] = "Deselect the active skill before picking up an item.",
            ["combat.ground.closed"] = "Ground items closed.",
            ["combat.ground.taken"] = "{0} moved to backpack. {1} Action Points remaining.",
            ...
            ["combat.enemy.with_weapon"] = "{0} with {1}",
            ...
            // Active man's usable skills, the numbered action bar (Shift+S).
            ...
            ["combat.inspect.body"] = "Health {0} of {1}. Morale: {6}. Head armor {2} of {3}. Body armor {4} of {5}.",
            ...
            ["combat.inspect.timing.unavailable"] = "Turn timing unavailable.",
            ["combat.inspect.turn"] = "{0}. {1} {2}",
            ["combat.inspect.turn.fatigue"] = "Fatigue {0} of {1}.",
            ["combat.inspect.effects"] = "Effects: {0}.",
            ["combat.inspect.effects.none"] = "No effects.",
            ["combat.inspect.bags"] = "Bag 1: {0}. Bag 2: {1}.",
            ["combat.inspect.armor.body"] = "Body: {0}, {1} of {2}.",
            ["combat.inspect.armor.head"] = "Head: {0}, {1} of {2}.",
            ["combat.inspect.armor.natural"] = "natural armor",
            ["combat.inspect.armor.none"] = "no armor",
            ...
            // Tactical combat.
            ["help.combat.cursor"] = "Q, W, E, A, S and D move the tile cursor to the six neighbours; visible enemies include their equipped weapon.",
            ["help.combat.recenter"] = "X recentres the cursor on the active man.",
            ["help.combat.enemies"] = "Z cycles the visible enemies by distance, Shift plus Z the other way; armed enemies include their weapon.",
            ["help.combat.allies"] = "H cycles your other men by distance, Shift plus H the other way.",
            ["help.combat.inspect"] = "V inspects the unit under the cursor; an armed enemy's name includes its weapon.",
            ["help.combat.inspectlist"] = "Shift plus V opens that inspection as a list, one fact per row.",
            ["help.combat.quickequipment"] = "Shift plus E reads the equipment of the unit under the cursor.",
            ["help.combat.quickeffects"] = "Shift plus F reads all effects on the unit under the cursor.",
            ["help.combat.quickstats"] = "Shift plus D reads damage, armor damage, head hit chance and vision for the unit under the cursor.",
            ["help.combat.quickbags"] = "Shift plus A reads bag slots 1 and 2 of the unit under the cursor.",
            ["help.combat.quickarmor"] = "Shift plus W reads the body and head armor of the unit under the cursor, with names and current durability.",
            ...
            ["help.combat.ground.move"] = "Up, Down, Home and End choose a ground item.",
            ["help.combat.ground.take"] = "Enter moves the focused ground item to the backpack.",
            ["help.combat.ground.close"] = "P or Escape closes the ground-item list.",
